...
the main Go net/http handler:
	...
	import (
		...
		httpmetrics "github.com/mansoormajeed/go-http-metrics/metrics/prometheus"
		httpmiddleware "github.com/mansoormajeed/go-http-metrics/middleware"
		httpstdmiddleware "github.com/mansoormajeed/go-http-metrics/middleware/std"
	)
...
import (
	...
	_ "github.com/mansoormajeed/go-http-metrics/metrics"
	// Import middleware package.
	_ "github.com/mansoormajeed/go-http-metrics/middleware"
)
